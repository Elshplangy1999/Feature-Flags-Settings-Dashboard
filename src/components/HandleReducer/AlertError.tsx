import { AlertErrorProps } from "@/types/AlertError/AlertError";
import React from "react";

const AlertError: React.FC<AlertErrorProps> = ({ error }: AlertErrorProps) => {
  return (
    <>
      <div className="flex min-h-screen w-full items-center justify-center px-4">
        <div className="flex w-full max-w-150 rounded-[10px] border-l-6 border-red-light bg-red-light-5 px-7 py-8 dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
          <div className="mr-5 mt-1.25 flex h-8 w-8 items-center justify-center rounded-md bg-red-light">
            <svg
              width="11"
              height="11"
              viewBox="0 0 11 11"
          ...
          <div className="w-full">
            <h5 className="mb-4 font-bold leading-5.5 text-[#BC1C21]">
              There is an error :
            </h5>
            <ul>
