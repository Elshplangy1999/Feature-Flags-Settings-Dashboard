import { ErrorNotificationProps } from "@/interfaces/Notify/ErrorNotificationProps";
import React from "react";

const ErrorNotification: React.FC<ErrorNotificationProps> = ({ title, message, onClose }) => {
  return (
    <div className="max-w-122.5 rounded-lg border border-red-light-4 bg-red-light-6 py-4 pl-4 pr-5.5 dark:border-[#EA4E2C] dark:bg-[#1B1B24]">
      <div className="flex items-center justify-between">
        ...
        <div>
          <button
            onClick={onClose}
            className="flex text-red-light hover:text-red"
          >
            <svg
